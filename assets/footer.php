	...
	<div class="m modal1">
		...
		<form class="hp143">
				...
				<label class="hp146">
					...
					<input type="tel" class="input1 phone-mask" name="notPhone" placeholder="Телефон" >
				</label>				
				<label class="hp146">
				...
				<div class="hp149">Нажимая на кнопку «Записаться», вы соглашаетесь с <a href="#" target=_blank class="hp156">правилами использования и обработки персональных данных</a></div>
	...
	<div class="m modal2">
		...
		<i class="fas fa-times hp144 mclose"></i>
		<form class="hp143">				
			<div class="hp145">Выберите город</div>
			<div class="hp157">
				<div class="hp158 active">Воронеж <i class="fas fa-check"></i></div>
				<div class="hp158">Казань <i class="fas fa-check"></i></div>
				<div class="hp158">Пермь <i class="fas fa-check"></i></div>
				<div class="hp158">Москва <i class="fas fa-check"></i></div>
				<div class="hp158">Новосибирск <i class="fas fa-check"></i></div>
				<div class="hp158">Набережные челны <i class="fas fa-check"></i></div>
			</div>				
		</form>
